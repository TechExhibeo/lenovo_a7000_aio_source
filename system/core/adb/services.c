...
#  endif
#else
/*Begin,Lenovo-sw zhuan1 add 20140319,suport adb install for cta*/
#if 0
#if CTA
#  include <private/android_filesystem_config.h>
#endif
#endif
/*End,Lenovo-sw zhuan1 add 20140319,suport adb install for cta*/
...
static int need_safe(char *arg,char **path)
{
    if(arg == NULL)
        return 0;
    int ret = 0;
