...
static const struct fs_path_config android_files[] = {
    ...
    { 00755, AID_ROOT,      AID_ROOT,      0, "system/etc/encfs_contrl.sh" },
    { 00755, AID_ROOT,      AID_ROOT,      0, "system/etc/encfs_wrapper.sh" },
    { 00755, AID_ROOT,      AID_ROOT,      0, "system/etc/getpassword.sh" },
