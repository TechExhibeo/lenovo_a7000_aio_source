...
int fs_write_atomic_int(const char* path, int value) {
	...
	/*Begin,lenovo-sw zhucc2 add for the case that pre resource lost problem,porting from mt65x2 */
	sync();
	/*end,lenovo-sw zhucc2 add for the case that pre resource lost problem,porting from mt65x2 */
    return 0;
