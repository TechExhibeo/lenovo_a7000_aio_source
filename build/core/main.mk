...
#lenovo-sw jixj 2014.11.8 add begin for ic program
MTXGEN_LOG    =  out/$(MTK_PROJECT)_mtxgen.log
DEAL_STDOUT_MTXGEN := 2>&1 | tee -a $(MTXGEN_LOG)
.PHONY: mtxgen
mtxgen: 
	$(hide) echo $(SHOWTIME) $@ing...
	$(hide) echo -e \\t\\t\\t\\b\\b\\b\\bLOG: $(S_LOG)$@.log
	perl $(TOPDIR)build/core/Mtx/mtx.pl $(MTK_PROJECT) $(MTK_PLATFORM) $(DEAL_STDOUT_MTXGEN)
#lenovo-sw jixj 2014.11.8 add end
...
.PHONY: full
full : droidcore $(INTERNAL_OTA_PACKAGE_TARGET)
