...
my $CUSTOM_MEMORYDEVICE_H_NAME  = "$cwd/bootable/bootloader/preloader/custom/$task_dir_pro/inc/custom_MemoryDevice.h";
...
push(@INC, 'bootable/bootloader/preloader/tools/emigen/Spreadsheet');
push(@INC, 'bootable/bootloader/preloader/tools/emigen');
...
my $ett_calc_table_excel= "$cwd/build/core/Mtx/emmc/$memory_device_list_name";

if (-e "$cwd/build/core/Mtx/emmc/MemoryDeviceList_$task_dir_pro.xls")
{
    $ett_calc_table_excel = "$cwd/build/core/Mtx/emmc/MemoryDeviceList_$task_dir_pro.xls";
}
...
if(system ("cp $cwd/build/core/Mtx/MTXGenExe $cwd/out/target/product/$task_dir_pro/MTXGen/MTXGenExe") == 0)
{
...
if(system ("cp -r $cwd/build/core/Mtx/config $cwd/out/target/product/$task_dir_pro/MTXGen/")== 0)
{
...
if(($task_dir_Pla eq "MT6572") || ($task_dir_Pla eq "MT6582") || ($task_dir_Pla eq "MT6592")||($task_dir_Pla eq "MT6595")||($task_dir_Pla eq "MT6752"))
{
